  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Construction Tool Rental v1 - Where individual customers find the right tool for every job, effortlessly renting from our network of outlets."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Construction Tool Rental v1 - Where individual customers find the right tool for every job, effortlessly renting from our network of outlets.`}
            </Text>
            <Box
